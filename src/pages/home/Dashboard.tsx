...
const Home = () => {
  ...
  return (
    <Layout>
      <h1 className="px-5 lg:px-28 my-8 h1">Welcome</h1>
      <div className="px-5 lg:px-28 grid grid-cols-12 gap-x-0 lg:gap-x-10 gap-y-10">
        <div className="bg-white/70 lg:max-h-[35rem] rounded-3xl border p-10 col-span-12 lg:col-span-8">
        {!connected && <p className="text-gray-500 mb-4">Please connect your wallet to add title</p> }
           <form onSubmit={handleSubmit(onSubmit)} className="flex items-start mb-8 gap-3">
            <Input
